...
<?php 
    ...
    $res=$cn->query("SELECT id, nome, preco FROM produto where tipo='estrela'");
    session_start();
    $_SESSION['tipo']='estrelas';
?>
<!DOCTYPE html>
<html lang="pt">
<head>
...
<body>
    ...
    <nav id="menu-1">
            <ul>
                ...
                <li><a href="https://api.whatsapp.com/send?phone=5591984851975&text=Ol%C3%A1%2C%20gostaria%20de%20ajuda%20para%20escolher%20os%20bal%C3%B5es%20certos%20para%20minha%20festa!">Vendedores</a></li>
            </ul>
    </nav>
    <!--  final menu -->
